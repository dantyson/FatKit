...
(function(addon) {
    ...
    if (typeof define == "function" && define.amd) {
        define("fatkit-pagination", ["fatkit"], function(){
    ...
    UI.component('pagination', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$("[data-f-pagination]", context).each(function(){
                    var ele = UI.$(this);

                    if (!ele.data("pagination")) {
                        var obj = UI.pagination(ele, UI.Utils.options(ele.attr("data-f-pagination")));
                    }
                });
            });
        },
        ...
        selectPage: function(pageIndex, pages) {
            ...
            this.trigger('select.f.pagination', [pageIndex, this]);
        },
        ...
        _append: function(pageIndex, opts) {
            ...
            item = (pageIndex == this.currentPage) ? '<li class="f-active"><span>' + (options.text) + '</span></li>'
