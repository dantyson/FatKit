(function(addon) {
    ...
    if (typeof define == "function" && define.amd) {
        define("fatkit-sticky", ["fatkit"], function(){
    ...
    UI.component('sticky', {
        ...
        boot: function() {
            ...
            UI.$doc.on('scrolling.f.document', function() { checkscrollposition(); });
            ...
            UI.ready(function(context) {
                ...
                setTimeout(function(){
                    ...
                    UI.$("[data-f-sticky]", context).each(function(){

                        var $ele = UI.$(this);

                        if(!$ele.data("sticky")) {
                            UI.sticky($ele, UI.Utils.options($ele.attr('data-f-sticky')));
                        }
                    });
        ...
        init: function() {
            ...
            var wrapper  = UI.$('<div class="f-sticky-placeholder"></div>'), boundary = this.options.boundary, boundtoparent;
            ...
            this.sticky = {
                ...
                reset         : function(force) {
                    ...
                    var finalize = function() {
                        ...
                        this.element.removeClass([this.options.animation, 'f-animation-reverse', this.options.clsactive].join(' '));
                    ...
                    if (!force && this.options.animation && UI.support.animation) {
                        ...
                        this.element.addClass(this.options.animation+' '+'f-animation-reverse');
                    } else {
                        finalize();
                    }
                },
