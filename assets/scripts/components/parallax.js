(function(addon) {
	...
	if (typeof define == "function" && define.amd) {
		define("fatkit-parallax", ["fatkit"], function(){
	...
	UI.component('parallax', {
		...
		boot: function() {
			...
			UI.$doc.on("scrolling.f.document", checkParallaxes);
			...
			UI.ready(function(context) {
				...
				UI.$('[data-f-parallax]', context).each(function() {

					var parallax = UI.$(this);

					if (!parallax.data("parallax")) {
						var obj = UI.parallax(parallax, UI.Utils.options(parallax.attr("data-f-parallax")));
					}
				});
			});
		},
